...
\usepackage{amsmath}
\usepackage{lastpage}
\usepackage[top=2.5cm, bottom=2.5cm, left=3cm, right=2.5cm]{geometry} % 页边距设定
\usepackage{float}
\usepackage{multirow}
...
% ==================================== 全局变量设置 ==================================== 
\newcommand{\thistitle}{面向可解释自动驾驶规划的神经回路策略拓扑优化}     % 设置文章题目
...
\newcommand{\xiaosi}{\fontsize{12pt}{23pt}\selectfont}         % 小四, 行距固定值23磅（按规范）
...
\renewcommand{\contentsname}{\heiti\xiaoer 目\quad\ 录}
\dottedcontents{section}[1.5em]{\sihao\hei}{1.5em}{1pc} % 章目录格式：黑体四号
\dottedcontents{subsection}[3.5em]{\xiaosi\song}{2em}{1pc} % 节目录格式：宋体小四
\dottedcontents{subsubsection}[5.5em]{\xiaosi\song}{2.5em}{1pc} % 子节目录格式：宋体小四
% ====================================================================================


% ==================================== 定义标题格式 ==================================== 
\usepackage{titlesec}
% 章/节/子节标题段前段后间距（按规范：章 0.8 行 / 0.5 行；节 0.5 行 / 0.5 行）
\titlespacing*{\section}{0pt}{18.4pt}{11.5pt}
\titlespacing*{\subsection}{0pt}{11.5pt}{11.5pt}
\titlespacing*{\subsubsection}{0pt}{11.5pt}{11.5pt}
\titleformat{\section}{\centering\hei\xiaoer}{\thesection}{1em}{}
...
\usepackage{caption}
\usepackage{chngcntr}
\DeclareCaptionFont{wuhaosong}{\fontsize{10.5pt}{23pt}\selectfont \song} % 图标题：宋体五号，行距23磅
...
% ==================================== 设置表格标题格式 ================================
\DeclareCaptionFont{wuhaosongcu}{\fontsize{10.5pt}{23pt}\selectfont \song} % 表格标题：宋体五号，行距23磅，按规范不加粗
\captionsetup[table]{
